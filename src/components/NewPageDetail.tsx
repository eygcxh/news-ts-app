...
function NewPage(props: INews) {
  ...
  return (
    <div>
      ...
      <Link to={moreInfo} className="font-semibold">Links: <span className="text-blue-800 font-light hover:text-gray-500 underline hover:no-underline	">{moreInfo}</span></Link>
